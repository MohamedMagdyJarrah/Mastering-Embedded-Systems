...
#define CLOCK_ADC1_EN()                     RCC->APB2ENR |= (1<<9)
#define CLOCK_ADC2_EN()                     RCC->APB2ENR |= (1<<10)
#define CLOCK_TIM1_EN()                     RCC->APB2ENR |= (1<<11)
#define CLOCK_SPI1_EN()                     RCC->APB2ENR |= (1<<12)
#define CLOCK_TIM8_EN()                     RCC->APB2ENR |= (1<<13)
#define CLOCK_USART1_EN()                   RCC->APB2ENR |= (1<<14)
#define CLOCK_ADC3_EN()                     RCC->APB2ENR |= (1<<15)
#define CLOCK_TIM9_EN()                     RCC->APB2ENR |= (1<<19)
#define CLOCK_TIM10_EN()                    RCC->APB2ENR |= (1<<20)
#define CLOCK_TIM11_EN()                    RCC->APB2ENR |= (1<<21)
/* AHB Peripherals */
#define CLOCK_DMA1_EN()                     RCC->AHBENR |= (1<<0)
#define CLOCK_DMA2_EN()                     RCC->AHBENR |= (1<<1)
#define CLOCK_SRAM_EN()                     RCC->AHBENR |= (1<<2)
#define CLOCK_FLITF_EN()                    RCC->AHBENR |= (1<<4)
#define CLOCK_CRC_EN()                      RCC->AHBENR |= (1<<6)
#define CLOCK_FSMC_EN()                     RCC->AHBENR |= (1<<8)
#define CLOCK_SDIO_EN()                     RCC->AHBENR |= (1<<10)
/* APB1 Peripherals */
#define CLOCK_TIM2_EN()						RCC->APB1ENR |= (1<<0)
#define CLOCK_TIM3_EN()						RCC->APB1ENR |= (1<<1)
#define CLOCK_TIM4_EN()						RCC->APB1ENR |= (1<<2)
#define CLOCK_TIM5_EN()						RCC->APB1ENR |= (1<<3)
#define CLOCK_TIM6_EN()						RCC->APB1ENR |= (1<<4)
#define CLOCK_TIM7_EN()						RCC->APB1ENR |= (1<<5)
#define CLOCK_TIM12_EN()                    RCC->APB1ENR |= (1<<6)
#define CLOCK_TIM13_EN()                    RCC->APB1ENR |= (1<<7)
#define CLOCK_TIM14_EN()                    RCC->APB1ENR |= (1<<8)
#define CLOCK_WWD_EN()                    	RCC->APB1ENR |= (1<<11)
#define CLOCK_SPI2_EN()						RCC->APB1ENR |= (1<<14)
#define CLOCK_SPI3_EN()                  	RCC->APB1ENR |= (1<<15)
#define CLOCK_USART2_EN()                   RCC->APB1ENR |= (1<<17)
#define CLOCK_USART3_EN()                   RCC->APB1ENR |= (1<<18)
#define CLOCK_UART4_EN()                    RCC->APB1ENR |= (1<<19)
#define CLOCK_UART5_EN()                    RCC->APB1ENR |= (1<<20)
#define CLOCK_I2C1_EN()                   	RCC->APB1ENR |= (1<<21)
#define CLOCK_I2C2_EN()                    	RCC->APB1ENR |= (1<<22)
#define CLOCK_USB_EN()						RCC->APB1ENR |= (1<<23)
#define CLOCK_CAN_EN()                  	RCC->APB1ENR |= (1<<25)
#define CLOCK_BKP_EN()                	  	RCC->APB1ENR |= (1<<27)
#define CLOCK_PWR_EN()                   	RCC->APB1ENR |= (1<<28)
#define CLOCK_DAC_EN()               	    RCC->APB1ENR |= (1<<29)
